...
def screen1():  # Booking screen
    global screen_1
    screen_1 = Toplevel()
    screen_1.title('Booking Screen')
    screen_1.geometry('1500x800')
    screen_1.resizable(False, False)
    
    # def ask_number_people():  # To take input of number of people the ticket is being booked for
    #     label_ask = Button(screen_1, text='Please enter the number of people',
    #                     width=26, height=3, font=('Helvetica', 10))
    #     label_ask.place(x=15, y=0)
    #     askbox = Entry(screen_1, background='white',
    ...
    def RADIOBUTTON(t, xloc, yloc, pichandle, activebg='white', activefg='#1E66DA', f=('ComicSans', '25'), var=film_var):
        global button
        button = Radiobutton(screen_1, activebackground=activebg,
    ...
    def LABEL(t, xloc, yloc, foreg='black', backg='white', w=20, h=1, f=seat_font):  # Functions tp create label
        global label
        label = Label(screen_1, fg=foreg, bg=backg, activeforeground=foreg,
    ...
    #     pic = PhotoImage(master=screen_1, file=filepath)
    #     return pic
    ...
    thumbnail1 = PhotoImage(master=screen_1, file='1. BlackAdam (Small).png')
    thumbnail2 = PhotoImage(master=screen_1, file='2. 777_Charlie (Small).png')
    thumbnail3 = PhotoImage(master=screen_1, file='3. RRR (Small).png')
    thumbnail4 = PhotoImage(master=screen_1, file='4. PS1 (Small).png')
    thumbnail5 = PhotoImage(master=screen_1, file='5. Drishyam_2 (Small).png')
    thumbnail6 = PhotoImage(master=screen_1, file='6. Vikram_Vedha (Small).png')
    ...
    input_box = Entry(screen_1, background='white',
                    foreground='black', width=21, font=seat_font)
    input_box.place(x=82, y=235)

    people_bar = Scale(screen_1, variable=people_var, orient=HORIZONTAL, bd=1, font=(
        'Helvetica', 20), from_=1, to=10, length=400)
    people_bar.place(x=72, y=475)

    exit_button = Button(screen_1, text='Exit', width=10,
                        command=closewindow, height=1, font=('Helvetica', 15))
    exit_button.place(x=1375, y=755)

    submit_button = Button(screen_1, width=10, text='Proceed',
...
def screen2(): # Movie details screen
    ...
    with open('Movies.csv', 'r') as f:
        ...
        Movie_Label = Label(master=screen2, text=Movie_Name, font=Movie_Font, anchor=W)
        Language_Label = Label(master=screen2, text=Language, font=Movie_Font, anchor=W)
        Release_Label = Label(master=screen2, text=Release_Date,font=Movie_Font, anchor=W)
        Rating_Label = Label(master=screen2, text=Rating,font=Movie_Font, anchor=W)
        Movie_Heading = Label(master=screen2, text='Movie :',font=Movie_Font, anchor=E)
        Language_Heading = Label(master=screen2, text='Language :',font=Movie_Font, anchor=E)
        Release_Heading = Label(master=screen2, text='Release :',font=Movie_Font, anchor=E)
        Rating_Heading = Label(master=screen2, text='Rating :',font=Movie_Font, anchor=E)
        Booking_details_Heading = Label(master=screen2, text='Booking Details',font=Movie_Font, bg='grey')
        submit_button = Button(screen2, width=10, text='Proceed',font=('Helvetica', 16), command=screen3)

        # Placement of details:
        submit_button.place(x=1350, y=10)
...
def screen3():  # Seats allotment screen
    global screen_3
    screen_3 = Toplevel()
    screen_3.title('Booking Screen')
    screen_3.geometry('1500x800')
    screen_3.resizable(False, False)

    heading = Label(screen_3, activebackground='black', activeforeground='green',
    ...
    seat1 = Checkbutton(screen_3, activebackground=color,  bg=gold_seat_color, font=seat_font, text='A1',
                        width=seat_width, height=seat_height, variable=seat_var1, onvalue=1, offvalue=0, command=check_seats)
    seat2 = Checkbutton(screen_3, activebackground=color, bg=gold_seat_color, font=seat_font, text='A2', width=seat_width,
                        height=seat_height, variable=seat_var2, onvalue=1, offvalue=0, command=check_seats)
    seat3 = Checkbutton(screen_3, activebackground=color, bg=gold_seat_color, font=seat_font, text='A3', width=seat_width,
                        height=seat_height, variable=seat_var3, onvalue=1, offvalue=0, command=check_seats)
    seat4 = Checkbutton(screen_3, activebackground=color, bg=gold_seat_color, font=seat_font, text='A4', width=seat_width,
                        height=seat_height, variable=seat_var4, onvalue=1, offvalue=0, command=check_seats)
    seat5 = Checkbutton(screen_3, activebackground=color, bg=gold_seat_color, font=seat_font, text='A5', width=seat_width,
                        height=seat_height, variable=seat_var5, onvalue=1, offvalue=0, command=check_seats)
    seat6 = Checkbutton(screen_3, activebackground=color, bg=gold_seat_color, font=seat_font, text='A6', width=seat_width,
                        height=seat_height, variable=seat_var6, onvalue=1, offvalue=0, command=check_seats)
    seat7 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='B1', width=seat_width,
                        height=seat_height, variable=seat_var7, onvalue=1, offvalue=0, command=check_seats)
    seat8 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='B2', width=seat_width,
                        height=seat_height, variable=seat_var8, onvalue=1, offvalue=0, command=check_seats)
    seat9 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='B3', width=seat_width,
                        height=seat_height, variable=seat_var9, onvalue=1, offvalue=0, command=check_seats)
    seat10 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='B4',
                         width=seat_width, height=seat_height, variable=seat_var10, onvalue=1, offvalue=0, command=check_seats)
    seat11 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='B5',
                         width=seat_width, height=seat_height, variable=seat_var11, onvalue=1, offvalue=0, command=check_seats)
    seat12 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='B6',
                         width=seat_width, height=seat_height, variable=seat_var12, onvalue=1, offvalue=0, command=check_seats)
    seat13 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='C1',
                         width=seat_width, height=seat_height, variable=seat_var13, onvalue=1, offvalue=0, command=check_seats)
    seat14 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='C2', width=seat_width,
                         height=seat_height, variable=seat_var14, onvalue=1, offvalue=0, command=check_seats)
    seat15 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='C3', width=seat_width,
                         height=seat_height, variable=seat_var15, onvalue=1, offvalue=0, command=check_seats)
    seat16 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='C4', width=seat_width,
                         height=seat_height, variable=seat_var16, onvalue=1, offvalue=0, command=check_seats)
    seat17 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='C5', width=seat_width,
                         height=seat_height, variable=seat_var17, onvalue=1, offvalue=0, command=check_seats)
    seat18 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='C6', width=seat_width,
                         height=seat_height, variable=seat_var18, onvalue=1, offvalue=0, command=check_seats)
    seat19 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='D1', width=seat_width,
                         height=seat_height, variable=seat_var19, onvalue=1, offvalue=0, command=check_seats)
    seat20 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='D2', width=seat_width,
                         height=seat_height, variable=seat_var20, onvalue=1, offvalue=0, command=check_seats)
    seat21 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='D3', width=seat_width,
                         height=seat_height, variable=seat_var21, onvalue=1, offvalue=0, command=check_seats)
    seat22 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='D4', width=seat_width,
                         height=seat_height, variable=seat_var22, onvalue=1, offvalue=0, command=check_seats)
    seat23 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='D5',
                         width=seat_width, height=seat_height, variable=seat_var23, onvalue=1, offvalue=0, command=check_seats)
    seat24 = Checkbutton(screen_3, activebackground=color, bg=normal_seat_color, font=seat_font, text='D6',
    ...
    screen_this_way = Label(screen_3, bg='black', fg='white', width=133, height=3, text='Screen this way', font=(
        'ComicSans', 15), activeforeground='white', activebackground='black', anchor=CENTER)
    screen_this_way.place(x=0, y=700)
    Submit_button = Button(
        screen_3, width=15, text='Submit', font=('Helvetica', 16), command=screen4)
    Submit_button.place(x=25, y=17)

submit_button = Button(window, width=10, text='Start', font=('Helvetica', 16), command=screen1)
submit_button.place(x=25, y=17)
