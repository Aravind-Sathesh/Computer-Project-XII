...
def screen_1():  # Movie selectionw
    ...
    def RADIOBUTTON(t, xloc, yloc, pichandle):
        global button
        button = Radiobutton(screen1, activebackground='white',
                             activeforeground='black', image=pichandle, variable=film_var, value=t)
...
def screen_4():  # Confirming all details
    ...
    for i in seatslist:
        seat_str += f'{i},'
    new_str = seat_str[0:len(seat_str)-1]
