...
def screen1():  # Booking screen
    ...
    thumbnail6 = PhotoImage(
        master=screen_1, file='6. Vikram_Vedha (Small).png')
...
def screen2():  # Movie details screen
    ...
    with open('Movies.csv', 'r') as f:
        ...
        Rating_Label = Label(master=screen2, text=Rating,
                             font=Movie_Font, anchor=W)
        Movie_Heading = Label(
            master=screen2, text='Movie :', font=Movie_Font, anchor=E)
        ...
        Booking_details_Heading = Label(
            master=screen2, text='Booking Details', font=Movie_Font, bg='grey')
        submit_button = Button(screen2, width=10, text='Proceed', font=(
...
def screen3():  # Seats allotment screen
    ...
    screen_this_way = Label(screen_3, bg='black', fg='white', width=139, height=3, text='Screen this way', font=(
        'ComicSans', 15), activeforeground='white', activebackground='black', anchor=CENTER)
    screen_this_way.place(x=0, y=675)
...
submit_button = Button(window, width=10, text='Start',
